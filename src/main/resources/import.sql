...
-- insert into clients (id, name, last_name, email, phone_number, user_id) values (4, 'Inglis', 'Doll', 'idoll3@angelfire.com', '330-495-6272', 4);
-- insert into clients (id, name, last_name, email, phone_number, user_id) values (5, 'Alisun', 'Mullin', 'amullin4@163.com', '330-495-6272', 5);
--
--
-- -- Loant
--
-- insert into loan (id, amount, client_id,create_at) values (1, 16493.90, 1,'2/6/2023');
-- insert into loan (id, amount, client_id,create_at) values (2, 2965.52, 2,'2/6/2023');
...
-- insert into loan (id, amount, client_id,create_at) values (6, 6427.28, 1,'2/6/2023');
-- insert into loan (id, amount, client_id,create_at) values (7, 3752.73, 2,'2/6/2023');
-- insert into loan (id, amount, client_id,create_at) values (8, 13911.36, 1,'2/6/2023');
-- insert into loan (id, amount, client_id,create_at) values (9, 3458.93, 1,'2/6/2023');
