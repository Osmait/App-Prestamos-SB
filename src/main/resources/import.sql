...
-- -- -- Loant
-- --
-- insert into loan (id, amount, client_id,create_at,payment_date ) values (1, 16493.90, 1,'2/6/2023','4/2/2023');
-- insert into loan (id, amount, client_id,create_at,payment_date ) values (2, 2965.52, 1,'2/6/2023','4/1/2023');
-- insert into loan (id, amount, client_id,create_at,payment_date ) values (3, 7823.36, 3,'2/6/2023','4/1/2023');
-- insert into loan (id, amount, client_id,create_at,payment_date) values (4, 15143.03, 4,'2/6/2023','4/2/2023');
-- insert into loan (id, amount, client_id,create_at,payment_date)values (5, 15878.89, 5,'2/6/2023','4/3/2023');
